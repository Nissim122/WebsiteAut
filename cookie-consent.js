  ...
  function showBanner() {
    ...
    card.innerHTML = [
      '<div style="display:flex;align-items:flex-start;gap:0.85rem;">',
        ...
        '</svg>',
        '<div>',
          '<p style="font-size:0.95rem;font-weight:700;margin-bottom:0.25rem;line-height:1.3;">אנחנו משתמשים בעוגיות</p>',
          '<p style="font-size:0.82rem;line-height:1.65;color:rgba(255,255,255,0.6);">',
            'אנו משתמשים ב-Google Analytics כדי להבין אילו עמודים הכי שימושיים ולשפר את האתר.',
            ' לא מועברים נתונים לצדדים שלישיים.',
